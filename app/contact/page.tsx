  ...
  return (
    <div className="py-12">
      ...
      <div className="mt-6 flex items-center gap-4 text-sm text-zinc-300">
        ...
        <a className="rounded-md border border-white/10 px-4 py-2 hover:border-[#ff8820]" href="https://github.com/sentinelforsentry/Eduardo-Neto-2025-26" target="_blank" rel="noreferrer">GitHub</a>
      </div>
    </div>
  );
}
